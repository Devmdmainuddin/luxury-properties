                ...
                <form onSubmit={handleSubmit(OnSubmit)} className="space-y-12">
                    <div className="space-y-4">
                        <div>
                            ...
                            <input type="text" name="text" id="text" placeholder={`${user?.displayName}`} className="w-full px-3 py-2 border rounded-md dark:border-gray-300 dark:bg-gray-50 dark:text-gray-800"
                  ...
                  <span className="text-red-500">This field is required</span>
                        ...
                        <div className="space-y-2">
                            <div>
                                <button type="submit" className="w-full px-8 py-3 font-semibold rounded-md bg-violet-600 text-gray-50">Update</button>
                            </div>
